...
exports.deleteMilestoneById = exports.updateExistingMilestone = exports.createNewMilestone = exports.findDistinctMilestoneLevels = exports.findMilestoneById = exports.findAllMilestonesbyGid = exports.findAllMilestones = exports.LEVEL_MAPPING = void 0;
const db_1 = __importDefault(require("../utils/db")); // Import the database connection pool
const gurukulService_1 = require("./gurukulService"); // Import to validate oid
 ...
 */
const isValidLevelForGType = (gtype, level) => {
    const allowedLevels = exports.LEVEL_MAPPING[gtype];
 ...
 */
const findAllMilestones = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield db_1.default.query('SELECT mid, class, level, oid FROM public.milestones ORDER BY mid ASC');
        return result.rows;
    }
    catch (error) {
...
exports.findAllMilestones = findAllMilestones;
const findAllMilestonesbyGid = (gid) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.findAllMilestonesbyGid = findAllMilestonesbyGid;
/**
 ...
 */
const findMilestoneById = (mid) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield db_1.default.query('SELECT mid, class, level, oid FROM public.milestones WHERE mid = $1', [mid]);
...
exports.findMilestoneById = findMilestoneById;
/**
 ...
 */
const findDistinctMilestoneLevels = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield db_1.default.query('SELECT DISTINCT level FROM public.milestones ORDER BY level ASC');
...
exports.findDistinctMilestoneLevels = findDistinctMilestoneLevels;
/**
 ...
 */
const createNewMilestone = (milestoneData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const existingMilestone = yield db_1.default.query('SELECT mid FROM public.milestones WHERE oid = $1 AND level = $2', [oid, level]);
        ...
        const result = yield db_1.default.query('INSERT INTO public.milestones (class, level, oid) VALUES ($1, $2, $3) RETURNING mid, class, level, oid', [milestoneClass, level, oid]);
 ...
 */
const updateExistingMilestone = (mid, milestoneData) => __awaiter(void 0, void 0, void 0, function* () {
    const { class: milestoneClass, level, oid } = milestoneData;
    const fields = [];
    const values = [];
    let paramIndex = 1;
    // Fetch current milestone data to get its existing oid/level for comparison
    const currentMilestone = yield (0, exports.findMilestoneById)(mid);
    if (!currentMilestone) {
    ...
    const targetOffering = yield (0, gurukulService_1.findGurukulOfferingById)(targetOid);
    if (!targetOffering) {
    ...
    const existingDuplicateMilestone = yield db_1.default.query('SELECT mid FROM public.milestones WHERE oid = $1 AND level = $2 AND mid != $3', [targetOid, targetLevel, mid]);
...
exports.updateExistingMilestone = updateExistingMilestone;
/**
 ...
 */
const deleteMilestoneById = (mid) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const result = yield db_1.default.query('DELETE FROM public.milestones WHERE mid = $1 RETURNING mid', [mid]);
        return ((_a = result.rowCount) !== null && _a !== void 0 ? _a : 0) > 0; // True if at least one milestone was deleted
    }
    catch (error) {
...
exports.deleteMilestoneById = deleteMilestoneById;
